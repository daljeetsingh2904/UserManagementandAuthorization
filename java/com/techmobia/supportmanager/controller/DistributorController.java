...
import com.techmobia.supportmanager.services.DistributorFileReader;
...
public class DistributorController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DistributorFileReader distributorfilereader;
		...
		try {
			if(ServletFileUpload.isMultipartContent(request)){
                ...
                distributorfilereader=new DistributorFileReader(dataupload.getFilePath(),dataupload.getFileName(),dataUploadList.get(0).split("@")[1]);
                Thread distributorfilethread=new Thread(distributorfilereader);
                distributorfilethread.start();
			}else {
