 ...
 *
 */
public class DistributorFileReader implements Runnable {
	private static final Logger logger = Logger.getLogger(DistributorFileReader.class);
	
	private String fileName;
	private String filePath;
	private String fileUploadId;
	
	public DistributorFileReader(String filePath,String fileName,String fileUploadId) {
	...
	public void run() {
		...
		try {
			...
			DbHandler.getInstance().addDistributorFileRecords(fileData,fileUploadId);
